...
- URL filtering logic now correctly prioritizes ignore rules over allow rules
...
[0.2.1]: https://github.com/AmanSikarwar/agent-skills-generator/compare/v0.2.0...v0.2.1
